 ...
 * @author yazan
 */
public class ReportColString extends ReportCol
{
    public ReportColString( String dbName, String caption )
    {
        super( dbName, caption ,3);
    }

    public ReportColString( String dbName, String caption ,int unit)
    {
